...
exports.TextSplitterChunker = void 0;
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            if (operation === 'extract') {
                const pattern = this.getNodeParameter('regex', i);
                ...
                const splitMethod = this.getNodeParameter('splitMethod', i);
                let chunks = [];
                switch (splitMethod) {
                    case 'length': {
                        const length = this.getNodeParameter('length', i);
                    ...
                    case 'word':
                        ...
                        break;
                    case 'regex': {
                        const pattern = this.getNodeParameter('splitRegex', i);
...
exports.TextSplitterChunker = TextSplitterChunker;
